...
dimensions = []
stencilSize = 128*128*128
gridNum = 128 #8*125 125*2**n(n>=0) 125 250 500 1000 2000 4000 8000 16000 32000
...
def FilterParams(spaceVector):
    ...
    if math.ceil (128/(blockDim[0] * unrollDim[0]))*math.ceil (128/(blockDim[1] * unrollDim[1]))*math.ceil (128/(blockDim[2] * unrollDim[2])) == gridNum:
        return True
