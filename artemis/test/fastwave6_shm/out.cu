...
__global__ void fastwave (double * __restrict__ d_ppgk, double * __restrict__ d_wgtfac, double * __restrict__ d_ppuv, int L, int M, int N) {
...
extern "C" void host_code (double *h_ppgk, double *h_wgtfac, double *h_ppuv, int L, int M, int N) {
	...
	fastwave <<<gridconfig_1, blockconfig_1>>> (ppgk, wgtfac, ppuv, L, M, N);
